...
- 完整规则、示例表与已知反例见 skill：[`.agent/skills/aim-common-rules/references/workspace-organization.md`](https://github.com/unnc-aim/aim-common-agentic-skills/blob/main/.agent/skills/aim-common-rules/references/workspace-organization.md)。

> 仓库命名完整规范（三种模式、决策树、大小写 / 分隔符对照、已知反例）见 skill：[`.agent/skills/aim-common-rules/references/repo-naming.md`](https://github.com/unnc-aim/aim-common-agentic-skills/blob/main/.agent/skills/aim-common-rules/references/repo-naming.md)。
...
- `ms-python.vscode-pylance` # 类型检查 / 智能提示，配置见 [`python-formatting.md`](https://github.com/unnc-aim/aim-common-agentic-skills/blob/main/.agent/skills/aim-common-rules/references/python-formatting.md) §6
...
规范全文也可直接在 GitHub 阅读：[`.agent/skills/aim-common-rules/references`](https://github.com/unnc-aim/aim-common-agentic-skills/tree/main/.agent/skills/aim-common-rules/references)（仓库命名 / Git 流程 / Python / C++ 格式化）。
